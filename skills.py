...
def all_odd(number_list):
    """Return a list of only the odd numbers in the input list of integers."""
...
def all_even(number_list):
    """Return a list of only the even numbers in the input list of integers """
